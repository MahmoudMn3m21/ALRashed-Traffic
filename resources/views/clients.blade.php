                            ...
                            <div class="client-card">
                                ...
                                <div class="client-info">
                                    ...
                                    @if ($client->description)
                                        <p class="client-description">{{ Str::limit($client->description, 80) }}</p>
                                    @endif
                                    @if ($client->website)
            ...
            @else
                <div class="col-12">
                    <div class="empty-state text-center py-5">
                        ...
                        <h3 class="text-muted">{{ __('clients.no_clients_title') }}</h3>
                        <p class="text-muted">{{ __('clients.no_clients_message') }}</p>
    ...
    <section class="section-padding">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="fade-in">
                        <h2 class="mb-3">{{ __('clients.cta_title') }}</h2>
                        <p class="lead mb-0">{{ __('clients.cta_subtitle') }}</p>
                    </div>
                </div>
